...
/* Enable color mode - To work with BUS_16bits must define USE_COLOR_RGB565 */
//#define USE_COLOR_RGB888   // RGB = 0xFF,0xFF,0xFF        With  8bit BUS
#define USE_COLOR_RGB565     // RGB = 0bRRRRRGGGGGGBBBBB    With 16bit BUS
